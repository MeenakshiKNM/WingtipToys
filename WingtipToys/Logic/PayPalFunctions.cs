...
public class NVPAPICaller
{
    ...
    public string APIUsername = "MeenaSeller_api1.hotmail.com";
    private string APIPassword = "1377523364";
    private string APISignature = "AIiAVgtaVaVwlKqLML309W6OO8YtABZ5eWNlizyGWrsRoPlgG5g75yxV";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "http://localhost:21084/Checkout/CheckoutReview.aspx";
        string cancelURL = "http://localhost:21084/Checkout/CheckoutCancel.aspx";
